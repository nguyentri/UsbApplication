...
#define HOST_OTG_FS_PORT_RCC               RCC_AHB1Periph_GPIOD
#define HOST_OVRCURR_PORT                  GPIOD
#define HOST_OVRCURR_LINE                  GPIO_Pin_5
#define HOST_OVRCURR_PORT_SOURCE           RCC_APB2Periph_SYSCFG
...
#define HOST_OVRCURR_EXTI_PORT_SOURCE			 EXTI_PinSource5
...
#define HOST_OTG_FS_PORT                   GPIOD
#define HOST_OTG_FS_RCC                    RCC_AHB2Periph_OTG_FS
...
static void USB_OTG_BSP_TimeDeInit ( void );
...
/**
  * @brief  USB_OTG_BSP_DeInit
  *         De-Initilizes BSP configurations
  * @param  None
  * @retval None
  */
...
void USB_OTG_BSP_DeInit(void)
{
   ...
   RCC_AHB1PeriphClockCmd(HOST_OTG_FS_PORT_RCC, DISABLE);  

   /* GPIO Periph clock Disable. */
   RCC_AHB1PeriphClockCmd(HOST_OVRCURR_PORT_RCC, DISABLE);
   /* Syscfg external interupt Disable. */
   RCC_APB2PeriphClockCmd(HOST_OVRCURR_EXTI_PORT_SOURCE, DISABLE);
   
   /* Disable the Overcurrent Interrupt */
   NVIC_InitStructure.NVIC_IRQChannel = HOST_OVRCURR_IRQn;
   ...
   RCC_AHB2PeriphClockCmd(HOST_OTG_FS_RCC, DISABLE) ; 

#endif //USB_OTG_FS

   /* De-Intialize Timer for delay function */
   USB_OTG_BSP_TimeDeInit();
}

/**
  * @brief  USB_OTG_BSP_TimeDeInit
  *         De-Initializes delay unit using Timer5
  * @param  None
  * @retval None
  */
static void USB_OTG_BSP_TimeDeInit ( void )
