...
/* BT Defines Legacy */ 
#define BT_WAKEUP        BT_WAKEUP
#define BT_TAMPER        BT_TAMPER
#define BT_KEY           BT_KEY
#define BT_RIGHT         BT_RIGHT
#define BT_LEFT          BT_LEFT
#define BT_UP            BT_UP
#define BT_DOWN          BT_DOWN
#define BT_SEL           BT_SEL
#define Mode_GPIO            BT_MODE_GPIO
#define Mode_EXTI            BT_MODE_EXTI
#define BT_Mode_TpDef  BTMode_TpDef
#define JOY_CENTER           JOY_SEL
#define JOY_State_TpDef    JOYState_TpDef 
