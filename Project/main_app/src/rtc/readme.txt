...
@par Example Description 
  ...
  4. When an RTC Alarm A event occurs the RTC Alarm interrupt is generated and the
   ...
   - When Tamper BT is pressed, the current time is displayed.
   - When WakeUp BT is pressed, the current alarm A is displayed. 
...
@par Hardware and Software environment 
  ...
  - STM324xG-EVAL/STM32437I-EVAL Set-up
    - Use the TAMPER push BT connected to PC.13 pin (EXTI Line13).
    - Use the WAKEUP push BT connected to PA.00 pin (EXTI Line0).
