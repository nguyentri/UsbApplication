/**
  ...
  * @brief   This file contains definitions for STM324xG_EVAL's Leds, push-BTs
...
/** @addtogroup STM324xG_EVAL_LOW_LEVEL_BT
  * @{
  */  
#define BT_NUM                          3 /*!< Joystick pins are connected to 
                                                an IO Expander (accessible through 
                                                I2C1 interface) */

/**
 * @brief Wakeup push-BT
 */
#define WAKEUP_BT_PIN                GPIO_Pin_0
#define WAKEUP_BT_GPIO_PORT          GPIOA
#define WAKEUP_BT_GPIO_CLK           RCC_AHB1Periph_GPIOA
#define WAKEUP_BT_EXTI_LINE          EXTI_Line0
#define WAKEUP_BT_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOA
#define WAKEUP_BT_EXTI_PIN_SOURCE    EXTI_PinSource0
#define WAKEUP_BT_EXTI_IRQn          EXTI0_IRQn 

/**
 * @brief Tamper push-BT
 */
#define TAMPER_BT_PIN                GPIO_Pin_13
#define TAMPER_BT_GPIO_PORT          GPIOC
#define TAMPER_BT_EXTI_LINE          EXTI_Line13
#define TAMPER_BT_GPIO_CLK           RCC_AHB1Periph_GPIOC
#define TAMPER_BT_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOC
#define TAMPER_BT_EXTI_PIN_SOURCE    EXTI_PinSource13
#define TAMPER_BT_EXTI_IRQn          EXTI15_10_IRQn 

/**
 * @brief Key push-BT
 */
#define KEY_BT_PIN                   GPIO_Pin_15
#define KEY_BT_GPIO_PORT             GPIOG
#define KEY_BT_GPIO_CLK              RCC_AHB1Periph_GPIOG
#define KEY_BT_EXTI_LINE             EXTI_Line15
#define KEY_BT_EXTI_PORT_SOURCE      EXTI_PortSourceGPIOG
#define KEY_BT_EXTI_PIN_SOURCE       EXTI_PinSource15
#define KEY_BT_EXTI_IRQn             EXTI15_10_IRQn
/**
  * @}
  */ 
