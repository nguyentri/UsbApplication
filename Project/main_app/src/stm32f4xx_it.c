...
extern void USB_OTG_BSP_EXTI_IRQ (USBH_HOST *phost);
...
{
   RETARGET_IRQHANDLER(RETARGET_UART_PORT_2);
}

void USART6_IRQHandler (void)
{
   RETARGET_IRQHANDLER(RETARGET_UART_PORT_6);
}
