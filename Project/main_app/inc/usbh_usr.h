...
/* Exported macros -----------------------------------------------------------*/
/*
** Create USB User Queue to receive message packets from Dataflash
*/
#define USH_USR_QUEUE_SIZE             (5)

/*
** USB message queue waiting: 100ms
** If the message queue is full, keyboard task shall give up
** after 10ms waiting.
*/
#define USH_USR_QUEUE_WAIT             (portTickType)(100 / portTICK_RATE_MS)
...
/* The queue used to receive messages from DATAFLASH READ task. */
extern xQueueHandle x_USB_USR_Queue;
/*USB core */
